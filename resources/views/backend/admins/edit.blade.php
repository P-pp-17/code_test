...
@section('content')
@include('backend.partials.commons._content_header', ['title' => 'Edit '. $admin->name])
        ...
        <form action="{{ route('backend.admins.update', $admin->id) }}" method="POST">
            ...
            <div class="card-body">
                ...
                <div class="form-group col-md-6">
                    ...
                    <select name="role_id" id="role" class="form-control js-select-2 @error('role_id') @enderror" data-selected="{{ old('role_id', $admin->role->id) }}">
                ...
                <div class="form-group col-md-6">
                    ...
                    <input type="text" class="form-control @error('name') is-invalid @enderror" id="name"
                        name="name" placeholder="Enter admin Name" value="{{ old('name') ?? $admin->name }}">
                    @error('name')
                ...
                <div class="form-group col-md-6">
                    ...
                    <input type="text" class="form-control @error('email') is-invalid @enderror" id="email"
                        name="email" placeholder="Enter Admin Email" value="{{ old('email') ?? $admin->email }}">
                    @error('email')
                ...
                <div class="form-group col-md-6">
                    ...
                    <div class="form-inline">
                        <div class="icheck-primary mr-2">
                            <input type="radio" id="yes" name="is_active" value="1" @if($admin->is_active == 1) checked @endif />
                            <label for="yes">Yes</label>
                        </div>
                        <div class="icheck-primary mr-2">
                            <input type="radio" id="no" name="is_active" value="0" @if($admin->is_active == 0) checked @endif/>
